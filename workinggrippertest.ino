...
const int trigPin = 6;  // digital pin for ultrasonic sensor trigger
const int echoPin = 5;  // digital pin for ultrasonic sensor echo
...
void loop()
{
    ...
    if (distance < 10)  // Adjust the threshold distance as needed
    {
        ...
        bChangeDir = false;  // Change direction
        ...
        if (forceValue < 100)
        {
          ...
          // stop contracting without changing direction or anthinge
          bHigh = true;
        }
    ...
    {
        bHigh = true;
        bChangeDir = true;  // Keep the gripper open

        //this should loosen the grip not just stop
    }
